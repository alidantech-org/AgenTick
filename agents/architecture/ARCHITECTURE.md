...
- `packages/agentick`: CLI and local runtime.
...
The local runtime discovers the Git root, loads `agents/agentick.yml`, watches configured files, appends JSONL events, indexes them in SQLite, and exposes a localhost dashboard.
